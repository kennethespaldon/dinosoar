...
function AddFlightForm({ selectedTab, setShowAddFlightForm }: { selectedTab: string, setShowAddFlightForm: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    return (
        <form className='add-flight-form'>
            ...
            <div className="add-flight-form-buttons">
                <button onClick={(e) => {
                    e.preventDefault();
                    setShowAddFlightForm(false);
                    console.log("cancel clicked")
                }} className='add-flight-form-cancel-button'>Cancel</button>
                <button className='add-flight-form-add-button' onClick={async (e) => {
                    e.preventDefault();
